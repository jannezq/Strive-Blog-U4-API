...
const blogPostPublicFolderPath = join(process.cwd(), "./public/img/blogPosts");
...
export const saveBlogPostAvatar = (fileName, fileContentAsBuffer) =>
  writeFile(join(blogPostPublicFolderPath, fileName), fileContentAsBuffer);
